...
class DBWNode(object):
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            throttle, brake, steering = self.controller.control(self.proposed_linear_velocity, self.proposed_angular_velocity,self.current_linear_velocity, self.current_angular_velocity,self.dbw_status) # <any other argument you need>)
